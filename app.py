...
DATABASE = {
    "0-12個月": {
        "顏色": {
            ...
            "文化藝術": "1. 「{theme}手掌蓋印」：小手沾無毒藍黃顏料蓋出《{book}》色彩圖案【色彩感知】\n2. 聆聽輕柔兒歌《顏色歌》，隨音樂接受肢體放鬆舒活按摩【舒活時間】\n(指標 II-4-5 / I-1-5)"
        },
        "中秋": {
        ...
        "父親": {
            ...
            "文化藝術": "1. 「給親愛家人的愛心手印」：彩色掌印蓋在《{book}》卡片上【手掌拓印】\n2. 聆聽溫馨兒歌，進行放鬆舒活按摩【舒活時間】\n(指標 I-1-5 / II-3-3)"
        },
        "default": {
    ...
    "12-24個月": {
        "顏色": {
            "身體動作": "1. 體能課：依指令做出「棕熊爬、小鳥飛、青蛙跳」大動作跨步【大肌肉模仿】\n2. 小肌肉/認知：將彩色毛球用小夾子舀入《{book}》同色杯中【精細操作】\n(指標 V-1-2 / V-1-5)",
    ...
    "24-36個月": {
        ...
        "default": {
            ...
            "文化藝術": "1. 藝術創作：「盛夏水果拼盤」色紙撕貼與黏土瓜子捏塑【撕貼創作】\n2. 配合快慢音樂節奏變換身體踩水律動【音樂擺動】\n(指標 VI-1-7 / VI-1-6)"
        }
    }
}
...
# --- 產生文件 2：適性發展活動月計畫 (進階版，已取消最下方簽核欄位) ---
